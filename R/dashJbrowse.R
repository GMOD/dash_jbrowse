...
dashJbrowse <- function(id=NULL, aggregateTextSearchAdapters=NULL, assembly=NULL, configuration=NULL, defaultSession=NULL, location=NULL, plugins=NULL, tracks=NULL) {
